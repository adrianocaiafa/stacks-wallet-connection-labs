...
export function ClaimGameRewardButton() {
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      const transaction = await makeContractCall({
        ...
        functionName: 'claim-game-reward',
        ...
        {success && rewardData && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            ...
            <div className="text-sm text-green-700 space-y-1">
              ...
              <p>Total de jogos: <span className="font-bold">{rewardData.totalGames}</span></p>
              <p>Vitórias: <span className="font-bold">{rewardData.wins}</span></p>
              <p>Taxa de vitória: <span className="font-bold">{rewardData.winRate}%</span></p>
            </div>
          </div>
        )}
