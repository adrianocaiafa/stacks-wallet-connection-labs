...
export function MultiTargetStartGame({ onStartSuccess }: { onStartSuccess?: () => void }) {
    ...
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      <div className="text-center mb-4">
        ...
        <p className="text-gray-600 text-sm mb-4">
          3 números (0–100) que somam um total conhecido. 15 tentativas. Sem custo, apenas gas.
        </p>
      </div>
      ...
      {success && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
          <p className="text-green-800 text-sm font-semibold">Jogo iniciado! Faça sua primeira tentativa.</p>
        </div>
      )}
