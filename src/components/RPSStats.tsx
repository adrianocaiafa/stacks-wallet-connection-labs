...
export function RPSStats() {
  const [stats, setStats] = useState<RPSStats | null>(null);
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const [totalGamesResult, userCountResult] = await Promise.all([
      ...
      setStats({
        totalGames: parseInt(String(totalGamesData.value || '0')),
