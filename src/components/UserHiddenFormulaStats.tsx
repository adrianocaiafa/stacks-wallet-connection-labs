...
export function UserHiddenFormulaStats() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      console.error('Erro ao buscar estatísticas do usuário Hidden Formula:', err);
      setStats(null);
      setActiveGame(null);
    } finally {
      setLoading(false);
    ...
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      ...
      {activeGame && (
        <div className="mb-4 p-3 bg-teal-50 border border-teal-200 rounded-lg">
          <p className="text-sm font-semibold text-teal-800">🎮 Jogo ativo</p>
      ...
      {!stats ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            <p className="text-2xl font-bold text-teal-600">{stats.totalGames}</p>
